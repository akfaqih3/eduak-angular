...
- [x] 12. إعداد نظام المسارات (Routing)




  - [x] 12.1 تكوين المسارات الرئيسية
  ...
  - [x] 12.2 تطبيق Guards على المسارات
...
- [x] 14. إعداد نظام التدويل (i18n)



  - [x] 14.1 تكوين مكتبة الترجمة
  ...
  - [x] 14.3 تطبيق الترجمة على المكونات
